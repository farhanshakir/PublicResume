    ...
    <div className="headerContainer">
      <div className="headerTextContainer">
        ...
        <p>
          ...
          experiences. With a programming background & over 6 years of experience in the field, I bring a
          unique blend of technical expertise and design acumen. My dedication to understanding user
          needs and translating them into visually captivating interfaces has led to successful 60+
