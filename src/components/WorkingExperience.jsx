        ...
        <div className="workingExperienceSection">
          ...
          <div className="workingExperienceSummaryContainer">
            ...
            <div className="workingExperiencePointsDiv">
              <ul>
                <li>
                  Led a team of designers and drove outstanding design solutions across 40+
                  projects.
                  <li>
        ...
        <div className="workingExperienceSection">
          ...
          <div className="workingExperienceSummaryContainer">
            ...
            <div className="workingExperiencePointsDiv">
              <ul>
                <li>
                  Entrepreneurial founder of The Photer, a service-based company providing
                  exceptional event photographers.
                </li>
              </ul>
            </div>
          </div>
